...
const UserList = () => {
    ...
    const changeContent = React.useContext(AppContext);
    return (
        <div className="usersContainer">
            <div className="users">
                <div className="user find_user" onClick={changeContent} >
                    <div className="pfp nopic">
                        <img src="./img/icons8-account-96.png" alt="" />
                    </div>
                    <div className="userinfo">
                        <div className="name user_search">
                            <p>Raskolnikov</p>
                        </div>
